...
> **Decisions logged 04:0x, same session (answers to section g):** g1 BuildFlow dependency → **decide later** (README note + TODO stand); g2 license → **switch to MIT** (LICENSE + README updated this session); g3 → **dogfood dependabot.yml only**, keep `master`.
