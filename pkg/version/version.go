// Package version holds the single source of truth for the
// dependabot-auto-configure version string. Every build self-identifies
// with the git commit it was built from, plus a "-dirty" suffix when the
...
//
// Fleet standard + adoption guide:
// ../file-and-image-renamer/docs/FLEET-STANDARD-VERSION-STAMPS.md
package version
...
//
//	-X github.com/larsartmann/dependabot-auto-configure/pkg/version.injected=<shortRev>
//
